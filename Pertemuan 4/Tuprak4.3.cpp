...
int main() {
    ...
    switch (pilih) {
        ...
        case 1:
            s1 = !s1; //negasikan
            switch(s1) {
                case true: cout << "Saklar 1 dinyalakan\n"; break;
                case false: cout << "Saklar 1 dimatikan\n"; break;
            }
            break;
        case 2:
            s2 = !s2; //negasikan
            switch(s2) {
                case true: cout << "Saklar 2 dinyalakan\n"; break;
                case false: cout << "Saklar 2 dimatikan\n"; break;
            }
            break;
        case 3:
            s3 = !s3; //negasikan
            switch(s3) {
                case true: cout << "Saklar 3 dinyalakan\n"; break;
                case false: cout << "Saklar 3 dimatikan\n"; break;
            }
            break;
        default:
            cout << "Input invalid\n";
